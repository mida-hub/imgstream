...
# Bucket notification for photos bucket (optional, for future use)
# resource "google_storage_notification" "photos_notification" {
#   bucket         = google_storage_bucket.photos.name
#   payload_format = "JSON_API_V1"
#   topic          = google_pubsub_topic.photos_topic.id
