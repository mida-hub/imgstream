...
class TestPerformanceIntegration:
    ...
    def test_large_batch_collision_detection_performance(self, mock_get_metadata_service):
        ...
        batch_sizes = [100]  # Reduced for testing
        ...
        for batch_size in batch_sizes:
            ...
            # Configure batch collision detection with proper return values
            ...
            mock_service.check_multiple_filename_exists.return_value = mock_check_multiple_exists(filenames)
    ...
    def test_collision_cache_performance(self, mock_get_metadata_service):
        ...
        assert call_count == 1  # One call for batch in first request only
    ...
    def test_concurrent_collision_detection(self):
        ...
        with patch("imgstream.utils.collision_detection.get_metadata_service") as mock_get_service:
            ...
            def mock_check_multiple_concurrent(batch_filenames):
                nonlocal call_count
                with call_lock:
                    call_count += 1
            ...
            mock_service.check_multiple_filename_exists.side_effect = mock_check_multiple_concurrent
            ...
            assert call_count == num_threads  # One call per thread
