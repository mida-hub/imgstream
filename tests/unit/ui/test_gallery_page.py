...
from src.imgstream.ui.components.gallery import (
...
class TestGalleryPage:
    ...
    def test_get_photo_thumbnail_url_error(self):
        ...
        with patch("src.imgstream.ui.handlers.gallery.get_storage_service") as mock_service:
            ...
            from src.imgstream.ui.handlers.gallery import get_photo_thumbnail_url
...
class TestGalleryPageIntegration:
    ...
    def test_gallery_page_functions_exist(self):
        ...
        from src.imgstream.ui.pages.gallery import render_gallery_page
        from src.imgstream.ui.handlers.gallery import (
            get_photo_original_url,
            get_photo_thumbnail_url,
            load_user_photos,
...
class TestGalleryPagination:
    ...
    def test_reset_gallery_pagination(self):
        ...
        from src.imgstream.ui.components.gallery import reset_gallery_pagination
    ...
    def test_load_user_photos_paginated_with_data(self):
        ...
        with (
            patch("src.imgstream.ui.handlers.gallery.get_metadata_service") as mock_service,
            patch("src.imgstream.ui.handlers.gallery.get_user_photos_count") as mock_count,
        ):
            ...
            from src.imgstream.ui.handlers.gallery import load_user_photos_paginated
    ...
    def test_get_user_photos_count(self):
        ...
        with patch("src.imgstream.ui.handlers.gallery.get_metadata_service") as mock_service:
            ...
            from src.imgstream.ui.handlers.gallery import get_user_photos_count
...
class TestPhotoDetailDisplay:
    ...
    def test_photo_detail_modal_session_state(self):
        ...
        # Modal functionality is now handled by st.dialog decorator
    ...
    def test_download_original_photo_success(self):
        ...
        with patch("src.imgstream.ui.handlers.gallery.get_photo_original_url") as mock_url:
            mock_url.return_value = "https://example.com/original.jpg"

            from src.imgstream.ui.handlers.gallery import download_original_photo
    ...
    def test_copy_image_url_success(self):
        ...
        with patch("src.imgstream.ui.handlers.gallery.get_photo_original_url") as mock_url:
            ...
            from src.imgstream.ui.handlers.gallery import copy_image_url
